...
import frame32svg from '../../../public/assets/Frame 3 (2).svg'
import eyeClosed from '../../../public/assets/Component 102.svg'
import eyeOpen from '../../../public/assets/18372143.png'
  ...
  return (
    ...
    <div className={styles.overlay}>
      <div className={styles.modal}>
        ...
        <Image src={frame32svg}  alt='' className={styles.frame32svg}/>
        ...
        <div className={styles.passwordWrapper}>
         ...
         <span className={styles.eye} onClick={() => setShowPassword(prev => !prev)}>
           <Image src={showPassword ? eyeOpen : eyeClosed}  alt='Toggle visibility'      
             className={styles.co}
             />
         </span>
        </div>
